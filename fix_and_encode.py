...
original_decoded = """from pyrogram import enums, types
        ...
        if private:
            rows += [
                [
                    ...
                    self.ikb(
                        text=lang["source"],
                        url="https://github.com/nishkarshk212/Amit-x-Music", style=ButtonStyle.DANGER
                    )
                ]
            ]
        else:
...
# Replace 'AloneX' with 'Amit'
fixed_code = original_decoded.replace("from AloneX import", "from Amit import").replace("from AloneX.core.lang", "from Amit.core.lang")

# Re-encode it
compressed = zlib.compress(fixed_code.encode("utf-8"))
encoded = base64.b64encode(compressed).decode("utf-8")

# Write the fixed _inline.py
fixed_content = f"""# Copyright (c) 2025 TheHamkerAlone
# Licensed under the MIT License.
# This file is part of AmitMusic
# ALONE-CODER
# POWERED BY ALONE

import zlib, base64; exec(zlib.decompress(base64.b64decode("{encoded}")).decode("utf-8"))
"""

with open("/Users/Developer/Desktop/billu badmosh/AloneX/Amit/helpers/_inline.py", "w") as f:
    f.write(fixed_content)

print("Fixed _inline.py!")
