...
from Amit import config
from Amit.helpers import Track
...
class Thumbnail:
    def __init__(self):
        ...
        self.font1 = ImageFont.truetype("Amit/helpers/Raleway-Bold.ttf", 30)
        self.font2 = ImageFont.truetype("Amit/helpers/Inter-Light.ttf", 30)
