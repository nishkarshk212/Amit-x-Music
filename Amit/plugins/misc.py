...
from Amit import anon, app, config, db, lang, queue, tasks, userbot, yt
from Amit.helpers import buttons
...
async def auto_clear_cache():
    ...
    while True:
        try:
            ...
            logger.info("Auto cache clearing: Cache cleared successfully")
        except Exception as e:
            logger.error(f"Auto cache clearing error: {e}")
...
tasks.append(asyncio.create_task(auto_clear_cache()))
